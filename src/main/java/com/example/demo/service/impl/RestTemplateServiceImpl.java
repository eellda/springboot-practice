...
public class RestTemplateServiceImpl implements RestTemplateService {
    ...
    public ResponseEntity<MemberDTO> postDto() {
        ...
        URI uri = UriComponentsBuilder.fromUriString("http://localhost:8080")
                ...
                .queryParam("organization", "read book")
                .encode()
                .build()
                .toUri();

        MemberDTO memberDTO = new MemberDTO();
        memberDTO.setName("TestDemo");
        memberDTO.setEmail("test@test.com");
        memberDTO.setOrganization("read book");
    ...
    public ResponseEntity<MemberDTO> addHeader() {
        ...
        RequestEntity<MemberDTO> requestEntity =
                RequestEntity.post(uri).header("header", "Test Demo").body(memberDTO);
